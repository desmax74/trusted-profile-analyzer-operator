...
For detailed instructions on how to deploy this Helm chart, please check [Red Hat Trusted Profile Analyzer documentation](https://docs.redhat.com/en/documentation/red_hat_trusted_profile_analyzer/2.2/html/deployment_guide/index).
